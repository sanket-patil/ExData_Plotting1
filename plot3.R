...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>ExData_Plotting1/plot3.R at master · sanket-patil/ExData_Plotting1</title>
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTU0MzUwMTpjZGIyMmRhY2FlZjc5ODQxNjM1NmNjMzFkYzkwYmIwNTpjZDllYTdiNTNhOGUxNWYzMGUxNmQ0Y2IyNWFiMTlhMjY3ODg3NzUxMDczMzBmMjliZTAyOTQwMDYwMTFlY2Yy--35e4d81975d2eeab6973d231d29ed82cde3ca767">
...
<meta content="hGSKlYktXMux8CGAnCE8wS1qHzl8zGJRKbtdA40hzzWLIX7nFqqTIm+jgHwzjP5M2tGVBYwp8CBe5KbEwNyJ7A==" name="csrf-token" />
...
<li>
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fw+bbQHh3pSXCTqGg8vsh2o0b2+bSg4+SZY8bccjiraKmMsST0e9oH6SXuSQmR58LS4JyYmEknC4vq/X3/cXwQ==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="aW0ldL8OT4rgTnXAJARdLxJFfmnSZ5Z4FlXDrITut+c/PQyqocj9XXtceH063hn8yHoiy/6/bv53tPppmr18Yw==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="29096824" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/sanket-patil/ExData_Plotting1/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="UwLU+FyyldeMyUBLeEfRI8Ep667xIvbqnl7SbOuxcYqM7rwugNUGejLF4c30bdqY8/EC+Qa3u231np4hvJVcbA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/sanket-patil/ExData_Plotting1/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="LPzN/vSMmkVZRVOsO50HhNsI19PKr/qc708985H8B8pFJMU3BrddQLVCZAcUqI/AmVVqxWcWezmK+YgfvE/Tbw==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
...
<a href="/sanket-patil/ExData_Plotting1/blob/705598bdc313ca8e409fccd3d1db1d1d64c3939d/plot3.R" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:ecd9d6524b985825240718e4227318df -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/sanket-patil/ExData_Plotting1/blob/master/plot3.R"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
          ...
          <form accept-charset="UTF-8" action="/sanket-patil/ExData_Plotting1/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="LZ3/qVv8eVpF/9IC0dJa5gjZyxKKmkEKMIbCBMILgRyL8ZSjN58AwbCFLubQL6Fzc4gtTF/IfuUmrPLCqpJKIw==" /></div>
...
<include-fragment class="commit commit-loader file-history-tease" src="/sanket-patil/ExData_Plotting1/contributors/master/plot3.R">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/sanket-patil/ExData_Plotting1/raw/master/plot3.R" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/sanket-patil/ExData_Plotting1/blame/master/plot3.R" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/sanket-patil/ExData_Plotting1/commits/master/plot3.R" class="btn btn-sm " rel="nofollow">History</a>
      </div>


            <form accept-charset="UTF-8" action="/sanket-patil/ExData_Plotting1/edit/master/plot3.R" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Hz8/nPve9+QkfHRiOXvJDIiangyCP757CCLZB+0OG05/K1e3QB+2X7MgIO+knqJllRHls6c/TfYoiU90x+qYpw==" /></div>
              <button class="octicon-btn tooltipped tooltipped-n" type="submit" aria-label="Edit this file" data-hotkey="e" data-disable-with>
                <span class="octicon octicon-pencil"></span>
              </button>
</form>
          <form accept-charset="UTF-8" action="/sanket-patil/ExData_Plotting1/delete/master/plot3.R" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="uroU2OstoEiXcxdGTxS/czHE2iu9Q1hXHm2mEoZQAfB4XtwVyOA8XJKKOssWS/DB7qcX34geLCFD8sTS8oR0mw==" /></div>
  ...
  <div class="blob-wrapper data type-r">
      ...
      <tr>
        ...
        <td id="LC13" class="blob-code blob-code-inner js-file-line">png(<span class="pl-s"><span class="pl-pds">&quot;</span>plot3.png<span class="pl-pds">&quot;</span></span>, <span class="pl-v">width</span> <span class="pl-k">=</span> <span class="pl-c1">480</span>, <span class="pl-v">height</span> <span class="pl-k">=</span> <span class="pl-c1">480</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-code blob-code-inner js-file-line">lines(<span class="pl-smi">DT</span><span class="pl-k">$</span><span class="pl-smi">DateTime</span>, <span class="pl-smi">DT</span><span class="pl-k">$</span><span class="pl-smi">Sub_metering_1</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC21" class="blob-code blob-code-inner js-file-line">dev.off()</td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04600s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
